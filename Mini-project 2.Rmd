...
party.df = expand.grid(immig.at = 0:4, pid7 = -3:3)
...
ggplot(party.pred.df, aes(x = immig.at, y = vote.T.prob, group = pid7, color = pid7)) + geom_line() + xlab("Immigration attitude") + ylab("Probability of voting Donald Trump") 
