...
```{r,fig.width=7}
p.1<- ggplot(data = with.img.pred.df, aes(x = vote.T.prob, group = pid7, color = pid7)) + geom_density() + ggtitle("With immigration\nattitude") + ylab("Density") + xlab("Probability of voting\nto Donald Trump") + ylim(0,35)
p.2<- ggplot(data = wout.img.pred.df, aes(x = vote.T.prob, group = pid7, color = pid7)) + geom_density() + ggtitle("Without immigration\nattitude") + ylab("Density")+ xlab("Probability of voting\nto Donald Trump")+ ylim(0,35)
